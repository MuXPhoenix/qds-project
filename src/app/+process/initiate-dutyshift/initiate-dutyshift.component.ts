...
@FadeInTop()
@Component({
  selector: 'app-initiate-dutyshift',
  templateUrl: './initiate-dutyshift.component.html',
  styleUrls: ['./initiate-dutyshift.scss']
})
export class InitiateDutyshiftComponent implements OnInit {
  formModel : FormGroup;
  datePickerConfig = {
    locale: 'zh-CN',
    format:'YYYY-MM-DD',
